<script lang="ts">
    ...
    async function submit() {
        const url = '/addpost?title=' + encodeURIComponent(title) +
                                '&body=' + encodeURIComponent(body) +
                                '&type=' + encodeURIComponent(Postto) +
                                '&tags=' + encodeURIComponent(tags.split(" ").join("%"));
        ...
        <form>
            <div class="grid w-full items-center gap-4">
                ...
                <div class="flex flex-col space-y-1.5">
                    ...
                    <Textarea id="Body" bind:value={body} placeholder="Type a message here." />
                </div>
                <div class="flex flex-col space-y-1.5">
                    <Label for="Tags">Tags</Label>
                    <Input id="Tags" bind:value={tags} placeholder="Type your tags here." />
                </div>
            </div>
        </form>
    </Card.Content>
